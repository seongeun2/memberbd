                            ...
                            <form>
                            	<div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label required" for="phone">ID<sup style="color:red">*</sup></label>
                                        <input id="id" name="id" type="text" class="form-control" placeholder="Enter Mobile ID">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label required" for="phone">생년월일<sup style="color:red">*</sup></label>
                                        <input id="id" name="id" type="text" class="form-control" placeholder="Enter Mobile ID">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <button class="btn btn-primary btn-block">다시작성</button>
                                    <button class="btn btn-primary btn-block">회원목록</button>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                </div>
                            </form>
